defmodule DemoAppWeb.CoreComponents do
  ...
  Here are useful references:
    ...
    * [Lucide](https://lucide.dev/icons/) via `lucide_icons` - see `icon/1` for usage.
  ...
  use Gettext, backend: DemoAppWeb.Gettext
  ...
  @doc """
  Renders a Lucide icon through `CinderUI.Icons.icon/1`.
  ...
  def icon(assigns) do
    ~H"""
    <CinderUI.Icons.icon name={@name} class={@class} />
    """
  end
